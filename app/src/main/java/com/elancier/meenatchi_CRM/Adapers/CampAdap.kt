...
import com.elancier.meenatchi_CRM.Camp_list
import com.elancier.meenatchi_CRM.Eod_list
import com.elancier.meenatchi_CRM.Meeting_Add
import com.elancier.meenatchi_CRM.R
import com.elancier.meenatchi_CRM.Schedule_Meeting

class CampAdap(private val context: Context, private val CentreArrays: ArrayList<Camp_list.EOD_data>, private val listener: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    override fun onCreateViewHolder(viewGroup:ViewGroup, viewType:Int): RecyclerView.ViewHolder {
        val productView = LayoutInflater.from(viewGroup.context).inflate(R.layout.camp_list_item, viewGroup, false)
    ...
    inner class ItemViewHolder internal constructor(rowView: View) : RecyclerView.ViewHolder(rowView), View.OnClickListener {
        ...
        init {
            ...
            tval = rowView.findViewById(R.id.camploc) as TextView
            created = rowView.findViewById(R.id.crmattribute) as TextView
