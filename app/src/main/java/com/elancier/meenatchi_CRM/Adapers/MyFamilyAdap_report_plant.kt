...
class MyFamilyAdap_report_plant(private val CentreArrays: List<CentresData>, private val context: Context, private val listener: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    inner class ItemViewHolder internal constructor(rowView: View) : RecyclerView.ViewHolder(rowView), View.OnClickListener {
        ...
        override fun onClick(view: View) {
            try {
                ...
                val a=Intent(context,Plant_report::class.java)
