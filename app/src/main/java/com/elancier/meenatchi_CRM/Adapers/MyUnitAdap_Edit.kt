...
class MyUnitAdap_Edit(private val CentreArrays: List<String>, private val context: Context, private val listener: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (viewType) {
            ITEM_CONTENT_VIEW_TYPE -> {
                ...
                (context as Family_Main).authenticationFragment!!.unitimg.visibility=View.INVISIBLE
