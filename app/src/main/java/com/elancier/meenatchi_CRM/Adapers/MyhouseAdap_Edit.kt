...
class MyhouseAdap_Edit(private val CentreArrays: List<String>, private val context: Context, private val listener: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
                ...
                holder.edit.setOnClickListener {
                    ...
                    builder.setItems(options) { dialog, item ->
                        if (options[item] == "Edit Photo") {
                            (context as Family_Main).authenticationFragment!!.selectImageedit1(position.toString())
                        } else if (options[item] == "Remove Photo") {

                            (context as Family_Main).authenticationFragment!!.removeImageedit1(position.toString())
