...
class SalesListAdapter_Products(private var items: JSONArray, private val context: Activity) : RecyclerView.Adapter<RecyclerView.ViewHolder>(),Filterable
{
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (viewType) {
            ITEM_CONTENT_VIEW_TYPE -> {
                ...
                val discount_amt = if (obj.has("date")) obj.getString("date") else ""
