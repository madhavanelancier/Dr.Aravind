...
import com.elancier.meenatchi_CRM.Travel_list

class TravelAdap(private val context: Context, private val CentreArrays: ArrayList<Travel_list.EOD_data>, private val listener: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    override fun onCreateViewHolder(viewGroup:ViewGroup, viewType:Int): RecyclerView.ViewHolder {
        val productView = LayoutInflater.from(viewGroup.context).inflate(R.layout.travel_list_item, viewGroup, false)
    ...
    inner class ItemViewHolder internal constructor(rowView: View) : RecyclerView.ViewHolder(rowView), View.OnClickListener {
        ...
        init {
            ...
            nm = rowView.findViewById(R.id.textView52) as TextView
            mob = rowView.findViewById(R.id.textView57) as TextView
            tval = rowView.findViewById(R.id.days) as TextView
            tval = rowView.findViewById(R.id.days) as TextView
            created = rowView.findViewById(R.id.textView61) as TextView
