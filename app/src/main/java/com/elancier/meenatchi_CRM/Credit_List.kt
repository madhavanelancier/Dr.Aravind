...
import com.elancier.meenatchi_CRM.Adapers.*
...
class Credit_List : AppCompatActivity(),RequestListAdapter.OnItemClickListener,ExpenseListAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      //  add_family.visibility=View.VISIBLE
        ...
        button9.setOnClickListener {
            if(idlist.isEmpty()){
                toast("Please select any list")
            }
            else{
                if(idlist.isNotEmpty()&&collectamount.text.toString().isNotEmpty()){
    ...
    fun toast(msg: String) {
        val toast = Toast.makeText(this@Credit_List, msg, Toast.LENGTH_SHORT)
    ...
    fun editarea(brcode: String, anm: String, acode: String, aid: String, short: String) {
        ...
        val dialogBuilder = AlertDialog.Builder(this@Credit_List)
// ...Irrelevant code for customizing the buttons and title
        val inflater = this@Credit_List.getLayoutInflater()
        ...
        add.setOnClickListener {
            ...
            if (fcode.text.toString().trim().isNotEmpty() && fage.text.toString().trim()
                ...
                progbar = Dialog(this@Credit_List)
            ...
            calls.enqueue(object : Callback<ResponseBody> {
                override fun onResponse(call: Call<ResponseBody>, responses: Response<ResponseBody>) {
                    ...
                    if (responses.isSuccessful) {
                        ...
                        adps = MyCreditAdap(Requestlist, activity,frm)
   ...
   /* fun Orders(){
    ...
    fun EditOffline(id: String, name: String){
        ...
        val popUpView = this@Credit_List!!.layoutInflater.inflate(R.layout.customer_order, null)
    ...
    fun clikffed(total:String,pos: Int,id:String,enable:String) {
        try {
            ...
            if(enable=="1"){
                ...
                textView85.setText("Total: "+totalamt)
    ...
    fun imgpo(pos: Int, req: String){
        if(CentresArraysdup1.isEmpty()){
            ...
            openwith.requestWindowFeature(Window.FEATURE_ACTION_MODE_OVERLAY);
            val popUpView = this@Credit_List!!.layoutInflater.inflate(R.layout.img_pop, null)
            var close=popUpView.findViewById<ImageButton>(R.id.imageButton10)
            title=popUpView.findViewById(R.id.textView16) as TextView
