...
class Eod_list : AppCompatActivity(),EODAdap.OnItemClickListener {
    ...
    var eodlist = ArrayList<EOD_data>()//JSONArray()
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        eoddata.cname="Dr.Aravind"
        eoddata.mmob="Rajaji Hospital, Madurai"
        eoddata.tval="01 May 2023 09:00 AM"
        eodlist.add(eoddata)

        val eoddata1=EOD_data()
        eoddata1.cname="Dr.Stephen"
        eoddata1.mmob="Velammal Hospital, Madurai"
        eoddata1.tval="04 May 2023 11:00 AM"
        eodlist.add(eoddata1)
