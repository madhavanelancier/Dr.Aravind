...
import com.elancier.meenatchi_CRM.Adapers.MyPlant_HarvAdap
...
class Fish_report : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pref = this@Fish_report.getSharedPreferences("MyPref", 0)
        ...
        ab!!.setTitle("Fish Harvest");
        ab!!.title="Fish Harvest"
        ...
        adp = MyPlant_HarvAdap(CentresArrays, this@Fish_report, click)
    ...
    fun families(){
        if (Appconstants.net_status(this)) {
            ...
            val call = ApproveUtils.Get.getMem2(Appconstants.Domin+"view_fishreport/"+posid)
                ...
                override fun onResponse(call: Call<Resp>, response: Response<Resp>) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (example.getStatus() == "Success") {
                            ...
                            var otpval= arr!!.data!![0].fish_harvest
                            ...
                            for(i in 0 until otpval!!.size) {
                                ...
                                data.CName = otpval[i].fish_type
                                data.Cid = otpval[i].id
                                data.CMembers = "Qty - "+otpval[i].harvest_qty+" KG"
                                data.CLocation = "Installed Date - "+otpval[i].seeded_date
                            ...
                            /*Toast.makeText(this@Fish_report, example.getStatus(), Toast.LENGTH_SHORT)
                                .show()*/
                            shimmer_view_container.visibility=View.GONE
                            textView23.visibility=View.VISIBLE
                            shimmer_view_container.stopShimmer()
