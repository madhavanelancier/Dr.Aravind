...
class Transaction_List : AppCompatActivity(),RequestListAdapter.OnItemClickListener,ExpenseListAdapter.OnItemClickListener {
...
// ...Irrelevant code for customizing the buttons and title
    ...
    fun Customers(){
        if (Appconstants.net_status(this)) {
            ...
            val calls = ApproveUtils.Get.getcollected_list(tid,pref.getString("empid", "").toString())
            val objs = JSONObject()
            objs.put("tid",tid)
            println("tourid"+tid)
